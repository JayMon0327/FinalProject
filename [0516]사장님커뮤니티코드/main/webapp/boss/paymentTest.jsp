...
<% if(session.getAttribute("user_id")!=null){ %>
<button class="subscribe-btn" onclick="requestPayment()">백체김치찌개 김치찌개 결제하기</button>
<button class="subscribe-btn" onclick="requestPayment2()">헤비스테이크 더블함박스테이크 결제하기</button>
<button class="subscribe-btn" onclick="requestPayment3()">감성타코 쉬림프타코 결제하기</button>
<button class="subscribe-btn" onclick="requestPayment4()">구구당 홍콩파스타 결제하기</button>
<button class="subscribe-btn" onclick="requestPayment5()">나폴리회관 피자라자냐 결제하기</button>
<button class="subscribe-btn" onclick="requestPayment6()">은행골 연어초밥 결제하기</button>
<%}else{ %>
